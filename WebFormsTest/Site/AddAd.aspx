...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <ajaxToolkit:AjaxFileUpload ID="AjaxFileUpload1" Enabled="false" runat="server" UseAbsoluteHandlerPath="false" AllowedFileTypes="jpg,jpeg,gif,png" OnUploadComplete="AjaxFileUpload1_UploadComplete" />
        </div>
        </div>
</asp:Content>