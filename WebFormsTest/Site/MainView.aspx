...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="comboBoxes">
        ...
        <div class="comboBox">
            ...
            <asp:DropDownList ID="streetComboBox" OnSelectedIndexChanged="streetComboBox_SelectedIndexChanged" runat="server" CssClass="form-control" Width="200" Height="30"></asp:DropDownList>
        </div>
